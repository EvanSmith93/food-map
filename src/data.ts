...
export const pinData = [
  {
    ...
    title: "Hummus",
    content: `1200s - Take chickpeas and pound them fine after boiling them. Then take vinegar, oil, tahineh, pepper, aṭrāf ṭīb, mint, parsley, the refuse of dry thyme, walnuts, hazelnuts, almonds, pistachios, Ceylon cinnamon, toasted caraway, dry coriander, salt, salted lemons and olives. Stir it and roll it out flat and leave it overnight and take it up `,
  },
  {
    id: "2",
    position: [35.6895, 139.6917], // Japan
    title: "Udon noodles",
    content: `1643 - Beat the flour as much as is necessary. For salt seasoning, put 1 shō of salt in 3 shō of water in summer, and 1 shō of salt in 5 shō of water in winter. Using this saltwater, mix in to season just right. Affix the dough on a millstone, and carefully and without vibration roll it up to roughly ball shaped and put it in a box. Wet a cloth, cover, and put it in a place where the wind doesn’t blow. Take out one at a time and beat it. Boil and season to taste. The broth is ninuki, or possibly taremiso. Garnish with black pepper and ume. 1 shō ≈ 1/2 gallon.`,
  },
  {
    id: "3",
    ...
    title: "Kneaded Bread",
    content:
      "Wash your hands and a bowl thoroughly. Pour meal into the bowl, add water gradually, and knead thoroughly. When it is well kneaded, roll out and bake under a crock.",
  },
  {
    id: "4",
